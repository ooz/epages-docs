...
At the beginning there was a short period of spare time for meet and greet as well as a brief introduction about the Softwerkskammer – the german part of the Software Craftsmanship Community – and its current distribution with some helpful contact information. 

Then the Docker Party, which celebrated the 3rd birthday of Docker, was launched! 
It consisted of an one hour talk including a demo to introduce the technological foundation and nearly three hours of different workshops for every skill level:
  ...
  - **Hidden:** Orchestration Workshop by Jerome Petazzino, the creater of Docker-in-Docker - also known as .

## The introduction, demo and best practises
